...
public class EnsureMovability extends AsyncTask{

    private static int MIN_POSSIBLE_MOVEMENTS = 5;
    private static int TRACE_MAX_LENGTH = 20;
    private static int MAX_TIME_MILLIS = 100;
    ...
    protected Boolean doInBackground(Object[] objects) {
        ...
        State startState = new State(normalCards, normalStacks, 0);
        State state = startState.deepCopy();
